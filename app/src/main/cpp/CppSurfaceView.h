...
JNIEXPORT void JNICALL Java_com_test_ntpdrw_NativeFunc_create(JNIEnv *env, jclass type, jint id);
JNIEXPORT void JNICALL Java_com_test_ntpdrw_NativeFunc_surfaceCreated(JNIEnv *env, jclass type, jint id, jobject surface);
JNIEXPORT void JNICALL Java_com_test_ntpdrw_NativeFunc_surfaceChanged(JNIEnv *env, jclass type, jint id, jint width, jint height);
JNIEXPORT void JNICALL Java_com_test_ntpdrw_NativeFunc_surfaceDestroyed(JNIEnv *env, jclass type, jint id);
...
extern "C" JNIEXPORT void JNICALL Java_com_test_ntpdrw_NativeFunc_create(JNIEnv *env, jclass clazz, jint id);
